...
% Mechanical system
joint.N = (160*3)/1; % Gear ratio
joint.J_load = 0.5*25*(0.3^2); % equivalent joint inertia 25kg*(0.3m)^2
joint.Jeq = motor.Jm + joint.J_load/(joint.N^2); % Equivalent inertia motor side
%% Speed controller
